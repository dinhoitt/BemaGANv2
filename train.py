...
from models import feature_loss, generator_loss, discriminator_loss, MultiEnvelopeDiscriminator, MultiResolutionDiscriminator, Generator
...
def train(rank, a, h):
    ...
    if cp_g is None or cp_do is None:
        ...
        med.load_state_dict(state_dict_do['med'])
                ...
                if steps % a.checkpoint_interval == 0 and steps != 0:
                    ...
                    save_checkpoint(checkpoint_path, 
                                    {'mrd': (mrd.module if h.num_gpus > 1
                                     ...
                                     'med': (med.module if h.num_gpus > 1
                                                         else med).state_dict(),
...
def main():
    ...
    parser.add_argument('--checkpoint_path', default='cp_BemaGanv2_MED_MRD')
